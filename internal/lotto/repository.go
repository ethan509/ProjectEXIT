...
func (r *Repository) GetLatestAnalysisStats(ctx context.Context) ([]AnalysisStat, error) {
	...
	for rows.Next() {
		...
		if firstProb.Valid {
			stat.FirstProb = firstProb.Float64
		}
		if lastProb.Valid {
			stat.LastProb = lastProb.Float64
		}
...
func (r *Repository) UpsertAnalysisStats(ctx context.Context, stats []AnalysisStat) error {
	...
	stmt, err := tx.PrepareContext(ctx,
		...
		ON CONFLICT (draw_no, number) DO UPDATE SET
			...
			first_prob = EXCLUDED.first_prob,
...
// High/Low Stats Methods

// UpsertHighLowStats 고저 비율 통계 저장/업데이트
func (r *Repository) UpsertHighLowStats(ctx context.Context, stat HighLowStatDB) error {
	_, err := r.db.ExecContext(ctx,
		`INSERT INTO lotto_high_low_stats (
			draw_no, actual_ratio,
			count_0_6, count_1_5, count_2_4, count_3_3, count_4_2, count_5_1, count_6_0,
			prob_0_6, prob_1_5, prob_2_4, prob_3_3, prob_4_2, prob_5_1, prob_6_0,
			calculated_at
...
// GetHighLowStatsByDrawNo 특정 회차의 고저 비율 통계 조회
func (r *Repository) GetHighLowStatsByDrawNo(ctx context.Context, drawNo int) (*HighLowStatDB, error) {
	var stat HighLowStatDB
	err := r.db.QueryRowContext(ctx,
		`SELECT draw_no, actual_ratio,
		        count_0_6, count_1_5, count_2_4, count_3_3, count_4_2, count_5_1, count_6_0,
		        prob_0_6, prob_1_5, prob_2_4, prob_3_3, prob_4_2, prob_5_1, prob_6_0,
		        calculated_at
		 FROM lotto_high_low_stats
		 WHERE draw_no = $1`, drawNo,
	).Scan(
		&stat.DrawNo, &stat.ActualRatio,
		&stat.Count0_6, &stat.Count1_5, &stat.Count2_4, &stat.Count3_3, &stat.Count4_2, &stat.Count5_1, &stat.Count6_0,
...
// GetLatestHighLowStatsDrawNo 고저 비율 통계가 계산된 가장 최근 회차 번호 조회
func (r *Repository) GetLatestHighLowStatsDrawNo(ctx context.Context) (int, error) {
	var drawNo int
	err := r.db.QueryRowContext(ctx,
		"SELECT COALESCE(MAX(draw_no), 0) FROM lotto_high_low_stats",
	).Scan(&drawNo)
	if err != nil {
		return 0, err
	}
...
// GetLatestHighLowStats 가장 최근 회차의 고저 비율 통계 조회
func (r *Repository) GetLatestHighLowStats(ctx context.Context) (*HighLowStatDB, error) {
	var stat HighLowStatDB
	err := r.db.QueryRowContext(ctx,
		`SELECT draw_no, actual_ratio,
		        count_0_6, count_1_5, count_2_4, count_3_3, count_4_2, count_5_1, count_6_0,
		        ...
		        calculated_at
		 FROM lotto_high_low_stats
		 WHERE draw_no = (SELECT COALESCE(MAX(draw_no), 0) FROM lotto_high_low_stats)`,
	).Scan(
		&stat.DrawNo, &stat.ActualRatio,
		&stat.Count0_6, &stat.Count1_5, &stat.Count2_4, &stat.Count3_3, &stat.Count4_2, &stat.Count5_1, &stat.Count6_0,
		&stat.Prob0_6, &stat.Prob1_5, &stat.Prob2_4, &stat.Prob3_3, &stat.Prob4_2, &stat.Prob5_1, &stat.Prob6_0,
...
// GetHighLowStatsHistory 고저 비율 통계 히스토리 조회
func (r *Repository) GetHighLowStatsHistory(ctx context.Context, limit int) ([]HighLowStatDB, error) {
	if limit <= 0 {
		limit = 50
	}
...
// GetHighLowStatsWithZeroProb prob이 모두 0인 행 조회 (수정 필요한 행)
func (r *Repository) GetHighLowStatsWithZeroProb(ctx context.Context) ([]HighLowStatDB, error) {
	rows, err := r.db.QueryContext(ctx,
		`SELECT draw_no, actual_ratio,
		        count_0_6, count_1_5, count_2_4, count_3_3, count_4_2, count_5_1, count_6_0,
		        prob_0_6, prob_1_5, prob_2_4, prob_3_3, prob_4_2, prob_5_1, prob_6_0,
...
// UpdateHighLowStatsProb 고저 비율 통계 prob 업데이트
func (r *Repository) UpdateHighLowStatsProb(ctx context.Context, stat HighLowStatDB) error {
	_, err := r.db.ExecContext(ctx,
		`UPDATE lotto_high_low_stats
		 SET prob_0_6 = $1, prob_1_5 = $2, prob_2_4 = $3, prob_3_3 = $4, prob_4_2 = $5, prob_5_1 = $6, prob_6_0 = $7,
		     updated_at = NOW()
		 WHERE draw_no = $8`,
		stat.Prob0_6, stat.Prob1_5, stat.Prob2_4, stat.Prob3_3, stat.Prob4_2, stat.Prob5_1, stat.Prob6_0,
