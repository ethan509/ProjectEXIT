...
func TestService_parseCSV(t *testing.T) {
	...
	// 테스트용 CSV 데이터
	// 실제 CSV 구조: No,회차,당첨번호(6개),보너스,순위,당첨게임수,1게임당 당첨금액
	csvContent := `No,회차,당첨번호,,,,,,보너스,순위,당첨게임수,1게임당 당첨금액
1,"1,208",6,27,30,36,38,42,25,1등,6 명,"5,001,713,625 원"
2,"1,207",10,22,24,27,38,45,11,1등,17 명,"1,733,202,949 원"
3,999,1,2,3,4,5,6,7,1등,5명(dirty),"1000원!"
`
